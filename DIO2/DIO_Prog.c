...
extern void DIO_voidInit(void) {
	...
	PORTC &= ~DIO_u8PORTDDIR;
	PORTD &= ~DIO_u8PORTCDIR;
...
extern u8 DIO_u8ReadPinValue(u8 Copy_u8PINIdx, u8* Copy_u8PtrToVal) {
	...
	case DIO_u8PORT0:
		...
		*Copy_u8PtrToVal = GetBit(PORTA, Copy_u8PINIdx);
		break;
	case DIO_u8PORT1:
		local_u8OperationStatus = ok;
		Copy_u8PINIdx = Copy_u8PINIdx % DIO_u8PINSPERPORT;
		*Copy_u8PtrToVal = GetBit(PORTB, Copy_u8PINIdx);
		break;
	case DIO_u8PORT2:
		local_u8OperationStatus = ok;
		Copy_u8PINIdx = Copy_u8PINIdx % DIO_u8PINSPERPORT;
		*Copy_u8PtrToVal = GetBit(PORTC, Copy_u8PINIdx);
		break;
	case DIO_u8PORT3:
		local_u8OperationStatus = ok;
		Copy_u8PINIdx = Copy_u8PINIdx % DIO_u8PINSPERPORT;
		*Copy_u8PtrToVal = GetBit(PORTD, Copy_u8PINIdx);
		break;
	default:
